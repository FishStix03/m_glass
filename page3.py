...
#introLabels
LabelIntro = Label(root, text = "SignUp: ", fg = '#DAEA14' , font=("Brush Script MT", 25), bg = '#000000')
...
boxLabel3 = Label(root, text = "Full Name", fg = '#DAEA14' , font=("American Typewriter", 12), bg = '#000000')
boxLabel3.grid(row = 9, column = 20)

entryBox3 = Entry(root, width = 18, fg = 'blue') #use .get() method to retirieve text
entryBox3.grid(row = 11, column = 20 )
